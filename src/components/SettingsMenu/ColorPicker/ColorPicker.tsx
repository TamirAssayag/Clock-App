...
export const ColorPicker = () => {
  const [hue, setHue] = React.useState("unset");
  ...
  return (
    <div className="hue-colors mb-1">
      <div className="hue-colors__wrapper">
        {colorArray.map((color) => (
          <div
            className="hue-colors__item"
            style={{ backgroundColor: color }}
            onClick={() => handleHueChange(color)}
          />
        ))}
      </div>
    </div>
